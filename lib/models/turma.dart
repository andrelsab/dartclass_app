class Turma {
  ...
  factory Turma.fromMap(Map<String, dynamic> map) {
    return Turma(
      ...
      qtdDeAlunos: map['qtdDeAlunos'] != null ? (map['qtdDeAlunos'] as num).toInt() : null,
  ...
  @override
  String toString() {
    return '${nomeDoCurso ?? "Curso desconhecido"} - ${semestre != null ? semestre.toString() + "º semestre" : "Sem semestre"}';
  }
}
